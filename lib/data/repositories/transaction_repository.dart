...
import 'merchant_alias_repository.dart';
...
class TransactionRepository {
  ...
  final MerchantAliasRepository _aliasRepository =
  ...
  Future<void> addTransaction(TransactionModel transaction) async {
    try {
      ...
      // Prevent duplicate notification imports
      ...
      if (transaction.merchant != null &&
        ...
        final alias = await _aliasRepository.getAlias(
  ...
  Future<List<TransactionModel>> searchTransactions(
    ...
    return _getTransactionsWithQuery(
      where: '''
lower(${DatabaseService.columnNotes}) LIKE ?
...
''',
  ...
  Future<List<TransactionModel>> getTransactionsByMonth(
    ...
    return _getTransactionsWithQuery(
      where:
          '${DatabaseService.columnDate} BETWEEN ? AND ?',
      whereArgs: [
      ...
      orderBy: '${DatabaseService.columnDate} DESC',
      errorMessage:
          'Failed to load transactions by month',
    );
  }
  ...
  Future<List<TransactionModel>>
    ...
    return _getTransactionsWithQuery(
      ...
      orderBy: '${DatabaseService.columnDate} DESC',
      errorMessage:
          'Failed to load transactions by date range',
    );
  }
  ...
  Future<double> getTotalBalance() async {
    try {
      ...
      throw AppException(
        'Failed to calculate total balance',
        cause: error,
      );
    }
  }
  ...
  Future<Map<String, double>>
    ...
    try {
      ...
      throw AppException(
        'Failed to calculate monthly summary',
        cause: error,
      );
    }
  }
  ...
  Future<Map<String, double>>
    ...
    try {
      ...
      for (final transaction in transactions) {
        final currentValue =
            summary[transaction.category] ?? 0.0;
      ...
      throw AppException(
        'Failed to calculate category summary',
        cause: error,
      );
    }
  }
